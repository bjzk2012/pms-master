layui.use(['form', 'upload', 'table', 'element', 'ax', 'laydate', 'cropper', 'croppers'], function () {
    ...
    var MyDisposal = {};
    // 我的发起和我的处理
    MyDisposal.initColumn = function () {
        return [[
    ...
    MyDisposal.search = function(){
        MyDisposal.table.reload({
            where: {
                ...
                phone: $("#myoriginateTablephone").val(),
    ...
    // 渲染表格
    MyDisposal.table = table.render({
        elem: '#myoriginateTable',
        domId: 'myoriginateTable',
        url: Feng.ctxPath + '/center/myoriginate/list',
        page: true,
        toolbar: "#toolbar",
        height: "full-132",
        even: true,
        cols: MyDisposal.initColumn(),
        where: {
            condition: '',
            projectId: '',
            category: '',
